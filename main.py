...
lagfile = "slm_init_41_10frame.nc" 
#forcefile = "semass_4x11_dply3_C_vertavge_only_3daytest.nc" 
#forcefile = "semass_4x31_dply3_D_vertavge.nc" 
forcefile = "semass_4x31_dply3_C_surfUonly.nc"

select_GPU = "Tesla"  # GPU to use
select_PLATFORM = "NVIDIA"
