...
__kernel void findcell( __global int* incell, __global int* neney, __global int* eney, __global float* x, __global float* y,  __global float* xt, __global float* yt)
{
